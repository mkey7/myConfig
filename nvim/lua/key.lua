...
vim.keymap.set("n","<leader>co","<cmd>:copen<cr>",{noremap = true, silent = true}, {desc = "cw"})
...
vim.keymap.set("n","<leader>cO","<cmd>:colder<cr>",{noremap = true, silent = true}, {desc = "colder"})
vim.keymap.set("n","<leader>cN","<cmd>:cnewer<cr>",{noremap = true, silent = true}, {desc = "cnewer"})
